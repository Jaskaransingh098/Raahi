  ...
  return (
    <>
      ...
      <div className="terms-conditions-header">
        ...
        <p>Welcome to <span className="terms-header-p">TEAM RAAHI OUTDOORS AND HOLIDAYS PRIVATE LIMITED</span>. By using our travel and tourism services, you agree to comply with the following terms and conditions. Please read them carefully before booking with us.</p>
      </div>
      <div className="terms-conditions-container">
        ...
        <main className="terms-conditions-content" ref={contentRef}>
          <section id="booking" className="terms-conditions-section">
            <h2>
              <Wallet className="terms-conditions-icon" /> Booking and Payments
            </h2>
            <ul>
              <li>
              ...
              <li>
                Full payment must be made before the departure date. Failure to
                pay may result in cancellation.
              </li>
              <li>
          ...
          <section id="cancellation" className="terms-conditions-section">
            ...
            <ul>
              ...
              <li>
                In case of cancellation due to unforeseen circumstances (natural
                disasters, pandemics, etc.), rescheduling options may be
          ...
          <section id="liability" className="terms-conditions-section">
            ...
            <ul>
              <li>
                Raahi Outdoors acts as an agent for hotels and transport
                providers and is not liable for delays, cancellations, or
                service failures from third parties.
              </li>
              <li>
                The company is not responsible for any personal injury, loss, or
                damage during the trip. Travelers are advised to purchase travel
                insurance.
              </li>
              <li>
          ...
          <section id="conduct" className="terms-conditions-section">
            ...
            <ul>
              ...
              <li>
                Any misconduct that disrupts the tour may result in removal from
                the trip without a refund.
              </li>
            </ul>
          </section>
